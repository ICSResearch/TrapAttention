...
class SwinBlockSequence(BaseModule):
    ...
    def forward(self, x, hw_shape):
        ...
        if self.downsample:
            ...
            return x_down, down_hw_shape, x, hw_shape, outs
        else:
            return x, hw_shape, x, hw_shape, outs
...
class Swin(BaseModule):
    ...
    def __init__(self,
        ...
        # dpr = [drop_path_rate for i in range(total_depth)]
        dpr = [
    ...
    def forward(self, x):
        ...
        for i, stage in enumerate(self.stages):
            x, hw_shape, out, out_hw_shape, feats = stage(x, hw_shape)
